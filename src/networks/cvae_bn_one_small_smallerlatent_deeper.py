...
class Decoder(nn.Module):
    def __init__(self, condition_embedding_size=6, latent_dim=32):
        ...
        nn.BatchNorm2d(64),
        nn.PReLU(),
        nn.ConvTranspose2d(64, 64, kernel_size=3, stride=1, padding=1), # 8x8 -> 16x16
        nn.BatchNorm2d(64),
        nn.PReLU(),
        nn.Upsample(scale_factor=2, mode='nearest'),
        nn.ConvTranspose2d(64, 64, kernel_size=3, stride=1, padding=1),  # 16x16 -> 32x32
        nn.BatchNorm2d(64),
        nn.PReLU(),
        ...
        self.linear_decoder = nn.Sequential(
            ...
            nn.Linear(latent_dim + condition_embedding_size, 128), # **** why it doesn tworK?
            nn.BatchNorm1d(128),
            nn.PReLU(),
...
class CVAE(nn.Module):
    ...
    def __init__(self, shape_vocab_size=4, color_vocab_size=4, condition_embedding_size=6, hidden_size=16, latent_dim=16, device='cuda'):
        super().__init__()
